...
public class User implements UserDetails {
    ...
    @OneToMany(mappedBy = "user", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonManagedReference // Sérialiser cette partie
    private List<PlanningHoraire> planningHoraires; // Liste des horaires associés à l'utilisateur
    ...
    public String getUsername() {
        return email; // Retourner l'email comme nom d'utilisateur
    }
